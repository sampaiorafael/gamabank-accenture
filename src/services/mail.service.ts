...
const sendCreateAccountMail = async (user: string, codBank: string, agencia: string, cc: string) => {
    ...
    mailer.sendmail(from, to, subject, text, htmlTemplate.createAccMail(user, codBank, agencia, cc))
